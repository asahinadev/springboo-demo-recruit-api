...
public class CapsuleType extends MasterBase {

	static class Deserializer extends JsonDeserializer<CapsuleType> {
		...
		public CapsuleType deserialize(JsonParser p, DeserializationContext ctxt)
			...
			if (node.isValueNode()) {
				...
				return om.readValue(node.toString(), CapsuleType.class);
			}
			return null;
		}
